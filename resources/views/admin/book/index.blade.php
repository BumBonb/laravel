                                ...
                                <tbody>
                                    @foreach($books as $book)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.book.show', $book->id) }}"><ion-icon name="eye-outline" style="color: black"></ion-icon></a>
                                            </td>
                                            <td>
                                                <a href="{{ route('admin.book.edit', $book->id) }}"><ion-icon name="pencil-outline" style="color: black"></ion-icon></a>
                                            </td>
                                            <td>
